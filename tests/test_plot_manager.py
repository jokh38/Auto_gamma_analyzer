...
class TestPlotManager(unittest.TestCase):
    ...
    def setUp(self):
        """Set up a DataManager with loaded data for each test."""
    ...
    def test_generate_profile_data_preparation(self):
        ...
        # Check for the presence of all essential keys for plotting
        expected_keys = ['phys_coords', 'dicom_values', 'mcc_interp',
                         'mcc_phys_coords', 'mcc_values', 'dicom_at_mcc']
