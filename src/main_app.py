...
class GammaAnalysisApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        dicom_header_layout.addWidget(file_a_norm_label)
        ...
        self.file_a_norm_spin.setKeyboardTracking(False)
        dicom_header_layout.addWidget(self.file_a_norm_spin)
        ...
        mcc_header_layout.addWidget(file_b_norm_label)
        ...
        self.file_b_norm_spin.setKeyboardTracking(False)
        mcc_header_layout.addWidget(self.file_b_norm_spin)
    ...
    def connect_signals(self):
        ...
        self.file_a_norm_spin.editingFinished.connect(lambda: self.controller.update_normalization("A", self.file_a_norm_spin.value()))
        self.file_b_norm_spin.editingFinished.connect(lambda: self.controller.update_normalization("B", self.file_b_norm_spin.value()))
